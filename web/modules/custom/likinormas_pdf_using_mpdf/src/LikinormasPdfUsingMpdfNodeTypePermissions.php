...
namespace Drupal\likinormas_pdf_using_mpdf;
 ...
 *
 * @package Drupal\likinormas_pdf_using_mpdf
 */
class LikinormasPdfUsingMpdfNodeTypePermissions implements ContainerInjectionInterface {
