...
namespace Drupal\likinormas_pdf_using_mpdf\Controller;

use Drupal\Core\Controller\ControllerBase;
use Drupal\Core\Entity\EntityTypeManagerInterface;
use Drupal\node\NodeInterface;
use Drupal\likinormas_pdf_using_mpdf\Conversion\ConvertToPdf;
use Drupal\Core\Url;
...
class GeneratePdf extends ControllerBase {
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      $container->get('likinormas_pdf_using_mpdf.conversion'),
