<?php
namespace Drupal\likinormas_pdf_using_mpdf\Form;
...
class AdminSettingsForm extends ConfigFormBase {
  ...
  public function getFormId() {
    return 'likinormas_pdf_using_mpdf_config';
  }
  ...
  protected function getEditableConfigNames() {
    return ['likinormas_pdf_using_mpdf.settings'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['tab_watermark']['watermark_image'] = [
      ...
      '#upload_location' => 'public://likinormas_pdf_using_mpdf',
      '#upload_validators' => [
  ...
  public function validateForm(array &$form, FormStateInterface $form_state) {
    ...
    if (!empty($values['watermark_image'])) {
      ...
      if (!$file->isPermanent()) {
        ...
        $file_usage->add($file, 'likinormas_pdf_using_mpdf', 'user', \Drupal::currentUser()->id());
      }
    }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->configFactory()
      ->getEditable('likinormas_pdf_using_mpdf.settings')
      ->set('likinormas_pdf_using_mpdf', $settings)
      ->save();
