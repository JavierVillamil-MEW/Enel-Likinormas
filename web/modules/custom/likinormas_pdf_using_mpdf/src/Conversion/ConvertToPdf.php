...
namespace Drupal\likinormas_pdf_using_mpdf\Conversion;

use Drupal\likinormas_pdf_using_mpdf\ConvertToPdfInterface;
...
class ConvertToPdf implements ConvertToPdfInterface {
  ...
  /**
   * likinormas_pdf_using_mpdf settings.
   *
   * @var array $settings
   */
  protected $settings;
  ...
  protected function generator($html) {
    ...
    try {
      ...
      $this->logger->get('likinormas_pdf_using_mpdf')->critical('Error:' . $message);
  ...
  public function getConfig() {
    return $this->configFactory
      ->getEditable('likinormas_pdf_using_mpdf.settings')
      ->get('likinormas_pdf_using_mpdf');
  }
    ...
    switch($this->settings['pdf_save_option']) {
      case 0:
        ...
        try {
          ...
          $this->logger->get('likinormas_pdf_using_mpdf')->critical($message);
        }
        break;
      ...
      case 2:
        ...
        try {
          ...
          $path = $folder . '/likinormas_pdf_using_mpdf/' . $filename . '.pdf';
